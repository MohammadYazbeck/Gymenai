...
export default function Back() {
  const backExercises = exercises.exercises.filter(exercise => exercise.main_bodypart === 'back');
  
  return (
    <>
    <div className="flex items-center text-left ml-[30rem] mt-24 fixed" >
     <div>
     <h1 className="text-4xl text-red-600 font-bold mb-3"> Back  Exercises </h1>
     <h2 className="text-lg text-gray-500 font-bold"> Please Select 3 Back  Exercises </h2>
     </div>   
