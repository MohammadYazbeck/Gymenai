...
const handleInputChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
  ...
  const handelSubmit = async (e: FormEvent) => {
    ...
    const photoError = employeeData.photo ? null : 'Please upload a photo.';
    setErrors({
      ...errors,
      photo: photoError || '',
    });
    ...
    if (Object.values(errors).some((error) => !!error)) {
      console.log('FORM ERROR ', 'VALIDATION ERRORS !!');
    ...
    try {
      ...
      const employeeSalary = String(employeeData.salary);
      if(employeeSalary){
      employeeFormData.append('salary', employeeSalary);
      }
      ...
      const response = await apiService.put(`emps/${state?.id}/`, employeeFormData, {
        headers: {
        ...
        <div className="ml-60 space-y-12 px-20 mt-28 lg:pl-60">
          <div className="pb-12">
            ...
            <div className="mt-20 pb-14 border-b border-gray-400/10 grid grid-cols-1 gap-x-5 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                <label htmlFor="photo" className="block text-md font-medium leading-6 text-gray-400">
                  Photo
                </label>
                <div className="mt-2">
                  <input
                    ...
                    name="photo"
                    id="photo"
                    className="block w-full rounded-md border-0 py-[0.15rem]  text-gray-400 shadow-sm ring-1 ring-inset ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-md sm:leading-6 bg-transparent font-bold"
                    onChange={handleInputChange}
